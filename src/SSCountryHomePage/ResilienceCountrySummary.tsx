...
export function ResilienceCountrySummary(props: Props) {
  ...
  return (
    <div className='margin-bottom-07'>
      <div className='flex-div flex-wrap stat-container'>
          ...
          <ValueCard
            value={
              data.indicators[
                data.indicators.findIndex(
                  d =>
                    d.indicator === 'COVID-19 Government Response Stringency',
                )
              ].yearlyData[
                data.indicators[
                  data.indicators.findIndex(
            ...
            graphDescription={
              indicators[
                indicators.findIndex(
                  d => d.DataKey === 'COVID-19 Government Response Stringency',
                )
              ].IndicatorDescription
            }
            source={
        ...
        {data.indicators.findIndex(d => d.indicator === 'Fiscal Response') !==
        -1 ? (
          <ValueCard
            value={
              data.indicators[
