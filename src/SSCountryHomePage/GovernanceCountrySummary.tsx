...
export function GovernanceCountrySummary(props: Props) {
      ...
      <div className='stat-card-container'>
        {data.indicators.findIndex(
          ...
          <ValueCard
            ...
            source={
              indicators[
                indicators.findIndex(d => d.DataKey === 'Rule of Law: Estimate')
              ].DataSourceName
            }
            graphDescription={
              indicators[
        ...
        {data.indicators.findIndex(d => d.indicator === 'State Legitimacy') !==
        -1 ? (
          <LineChart
            data={
              data.indicators[
