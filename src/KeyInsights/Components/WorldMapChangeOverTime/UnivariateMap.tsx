              ...
              <g
                ...
                onMouseEnter={event => {
                  setHoverData({
                    ...
                    val2015:
                      d.data[d.data.findIndex(el => el.year === 2015)].value,
                    valFinal: d.data[d.data.length - 1].value,
                    finalYear: d.data[d.data.length - 1].year,
      ...
      {hoverData ? (
        ...
        >
          <div style={{ padding: 'var(--spacing-03)' }}>
            <p className='undp-typography bold small-font'>
              {hoverData.country}
            </p>
            <p className='undp-typography margin-bottom-01 small-font'>
              Value in 2015
              <br />
              <span className='bold'>{hoverData.val2015}</span>
            </p>
            <p className='undp-typography margin-bottom-01 small-font'>
              Value in {hoverData.finalYear}
              <br />
              <span className='bold'>{hoverData.valFinal}</span>
            </p>
            <p className='undp-typography margin-bottom-00 small-font'>
              Change over time
              <br />
              <span className='bold'>
                {hoverData.val === 'Not Available'
                  ? hoverData.val
                  : hoverData.val.toFixed(2)}
              </span>
            </p>
          </div>
        </TooltipEl>
