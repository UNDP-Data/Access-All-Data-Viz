...
import {
  CONTINENTS, HDI_LEVELS, INCOME_GROUPS, MAX_TEXT_LENGTH, TRUNCATE_MAX_TEXT_LENGTH,
} from '../Constants';
                ...
                >
                  ...
                  >
                    <circle
                      ...
                      fill={d.colorVal ? colorScale(d.colorVal) as string : UNDPColorModule.graphGray}
                      fillOpacity={0.6}
                      stroke={d.colorVal ? colorScale(d.colorVal) as string : UNDPColorModule.graphGray}
                    />
                    {
                      showLabel
                        ? (
